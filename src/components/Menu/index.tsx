        ...
        <>
            ...
            <>

                {
                    ...
                    <div className='xl:hidden fixed top-16 right-16 z-10 bg-black p-3 border border-gray-400 rounded-full text-white'>
                        <MdMenuOpen size={25}/>
                    </div>
                }

                {
                    ...
                    initial={{opacity: 0}}
                    animate={{opacity: 1}}
                    className='flex z-10 fixed right-10 bg-black text-gray-300 text-xl border border-gray-500 py-9 px-4 flex-col gap-8 top-1/2 rounded-full'>
                    <div>
                        <a href="#introducao" className={`hover:text-[#319791] transition-colors ${currentSectionId === "introducao" && 'text-[#319791]'}`} onClick={handleScroll}><AiOutlineHome/></a>
                    </div>
